...
In this project, I learned abou three standard file descriptors and their
...
read, write, set permissions of files in 
...
* **4. elf**
  * [100-elf_header.c](./100-elf_header.c): C program that displays the information contained
  in the `EF` header at the start of an `ELF` file.
  ...
  * If an error occurs or the file is not an `ELF` file, the function displays a
  corresponding error message to `stderr` and exits with a status value of `98`.L
